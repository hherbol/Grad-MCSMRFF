...
#
## parse_tersoff_file(filename) - A function that, given a file name, will parse the tersoff data into a list of strings
#
## read_params(run_name, exact=False) - A function to read in MCSMRFF parameters from a file with the name input_run_name.tersoff
#                                      Using exact=True, it'll instead read in run_name.tersoff
#                                      This function returns three lists: lj_paramlist, atom_list, tersoff_paramlist
#                                          lj_paramlist - A list of lists.  The first is the charges, second is the LJ_sigma value and
#                                                         third is the LJ_epsilon values.
#                                          atom_list - A 1D list of strings holding all the atomic three-body interactions
#                                          tersoff_paramlist - A 1D list of floats holding the tersoff parameters for all three-body
#                                                              interactions
#
## write_params(lj_params,atom_list,tersoff_params,filename,append="_o") - A function to write out parameters to a file
#
## write_param_line(tersoff,i) - Write a single line of a tersoff input file (given the tersoff list and the index of the line. primarily written in conjunction with write_params
#
## write_atom_line(atom,i) - Write a single line of atoms (given the atom list and the index of the line. primarily written in conjunction with write_params
#
## write_system_and_training_data(run_name, system, systems_by_composition) - A function to write a system and training data to files
#
## parse_lammps_output(run_name, natoms) - A function to parse a LAMMPS output and return the single point energy and RMS force
####################################################################################################################################################################################
