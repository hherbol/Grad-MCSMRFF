...
def bfgs(run_name, step_size=0.05, step_size_adjustment=0.5, maxiter=1000, gtol=1E-3, perturbation=1.01,
         ...
         training_set_file_path=None, tersoff_atoms=mcsmrff_constants.tersoff_atoms):
    ...
    mcsmrff_gradient.run_lammps(atoms, systems_by_composition, tersoff_atoms, current_parameters[0], current_parameters[1], current_parameters[2], run_name)
    ...
    while (loop_counter < maxiter):
        ...
        mcsmrff_gradient.run_lammps(atoms, systems_by_composition, tersoff_atoms, new_parameters[0], new_parameters[1], new_parameters[2], run_name)
